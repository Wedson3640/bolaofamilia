...
export function CopiarLink({ slug }: { slug: string }) {
  ...
  const compartilharWhatsApp = () => {
    ...
    const texto = `🏆 Participe do meu bolão da Copa 2026!\n\nFaça sua aposta aqui: ${url}`;
  ...
  return (
    <div className="flex items-center gap-2 w-full">
      ...
      <span className="text-gray-400 text-xs font-mono flex-1 truncate">
        bolaofamilia.online/bolao/{slug}
      </span>
      ...
      <button
        ...
        className="shrink-0 flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-lg bg-[#25D366] hover:bg-[#1ebe5d] text-white transition-all"
      >
